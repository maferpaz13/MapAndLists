...
class VehCargaViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vehiculo = arrayReques[indexPath.row]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "showImagVeh" {
            ...
            destinationVC.manifiesto = manifiesto
        }
    ...
    func Obtenerinfo() {
        ...
        ViewModel.getVehCargueDescargue(id: id) { (Result) in
            ...
            if let arrayques = Result?.vehicles_load, let arrayManifest = Result?.document_requests_link {
