//
//  ServiciosSolicitadosModel.swift
//  MapAndLists
//
...
class ServiciosSolicitadosModel {

struct ServiciosSolicitadosData : Codable {
    let success : Bool?
    let type : String?
    let requests : [Requests]?
    let status : String?
    let carconfigs : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        carconfigs = try values.decodeIfPresent(String.self, forKey: .carconfigs)
    }
